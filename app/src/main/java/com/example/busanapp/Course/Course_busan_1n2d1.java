package com.example.busanapp.Course;

public class Course_busan_1n2d1 {
    ...
    */
    ...
    public Course_busan_1n2d1(String title, String category, String description1, String description2, String description3
                  , String description4, String description5, String description6, String description7, String description8
            , String description9, String description10, String description11, String description12, String description13, String description14,
                              int thumbnail1, int thumbnail2, int thumbnail3, int thumbnail4, int thumbnail5, int thumbnail6,
                              int thumbnail7, int thumbnail8, int thumbnail9, int thumbnail10, int thumbnail11, int thumbnail12) {
        Title = title;
