...
public class RecyclerViewAdapter_busan_1n2d1 extends RecyclerView.Adapter<RecyclerViewAdapter_busan_1n2d1.MyViewHolder> {
    private Context mContext;
    private List<Course_busan_1n2d1> mData;

    public RecyclerViewAdapter_busan_1n2d1(Context mContext, List<Course_busan_1n2d1> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, Course_Activity_busan_1n2d1.class);
